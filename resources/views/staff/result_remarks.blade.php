        ...
        <div class="card-body">
            ...
            <div class="container-fluid p-3">
                <div class="row">
                    <div class="col-md-4">
                        <div class="well">
                            <h4 class="margin">{{ isset($section) ? 'Edit' : 'Create' }} Result Remarks</h4>
                            <hr>
                            @isset($resultRemark)
                                <form action="{{ route('staff.result_remarks.update', $resultRemark->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $resultRemark->min_average }}" name="min_average"
                                            class="form-control">
                                        @error('min_average')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $resultRemark->max_average }}" name="max_average"
                                            class="form-control">
                                        @error('max_average')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $resultRemark->next_term_fee }}" name="next_term_fee"
                                            class="form-control">
                                        @error('next_term_fee')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                ...
                                <form action="{{ route('staff.result_remarks.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="academic_session_id" value="{{ old('academic_session_id') }}"
                                            ...
                                            <option value="">Select Session</option>
                                            @foreach ($academicSessions as $academicSession)
                                                <option value="{{ $academicSession->id }}">{{ $academicSession->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('academic_session_id')
                                    ...
                                    <div class="form-group">
                                        <label for="school_class_id">Classes</label>
                                        <select name="school_class_ids[]" id="class" class="form-control" multiple>
                                            <option value="">Select Class</option>
