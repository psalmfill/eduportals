...
@section('content')
    <div class="card">
        <div class="card-body">
            <h3>All Classes Subjects</h3>
            <div class="container-fluid p-3">
                <div class="row">
                    @if (!(user() instanceof \App\Models\Staff || user() instanceof \App\Models\Student))
                        <div class="col-md-4">
                            <div class="well">
                                <h4 class="margin text-primary">Assign Subjects</h4>
                                <hr>
                                @isset($school_class)
                                    <form action="{{ route('classes.subjects.assign', $school_class->id) }}" method="POST">
                                        @csrf
                                ...
                                @else
                                    <form action="{{ route('classes.subjects.assign') }}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach ($subjects->chunk(2) as $chunk)
                                                <div class="row">
