...
@section('breadcrum')
    <ol class="breadcrumb bc-3">
        ...
        <li>
            <a href="{{ route('vendor.schools.index') }}">
    ...
    <div class="card">
        <div class="card-body">
            <div class="well">
                ...
                <hr>
                @isset($school)
                    <form action="{{ route('vendor.schools.update', $school->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <input type="hidden" name="vendor" value="{{ user()->vendor->id }}" />
                        <div class="row">
                            <div class="col-md-6">
                ...
                @else
                    <form action="{{ route('vendor.schools.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="vendor" value="{{ user()->vendor->id }}" />
                        <div class="row">
                            <div class="col-md-6">
