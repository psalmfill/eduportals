    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="container-flui d-flex justify-content-end mb-3">
                ...
                <a href="{{ route('vendor.staff.create') }}" class="btn btn-primary pull-right">New Staff</a>
            </div>
                    ...
                    <div class="row striped border py-3 text-center align-middl">
                        ...
                        <div class="col-md-2 my-md-auto my-1">
                            <div class="d-flex justify-content-center">
                                <a href="{{ route('vendor.staff.show', $item->id) }}" class="btn btn-info btn-sm mr-1">
                                    View</a>
                                <a href="{{ route('vendor.staff.edit', $item->id) }}" class="btn btn-secondary btn-sm">
                                    Edit</a>
                            </div>
                        </div>
                    </div>
