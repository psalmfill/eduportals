                        ...
                        <div class="d-flex border-bottom py-4">
                            <span
                                ...
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                    ...
                                    <desc>Created with Sketch.</desc>
                                    <g id="Stockholm-icons-/-Communication-/-Add-user" stroke="none"
                                ...
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                    ...
                                    <g id="Stockholm-icons-/-Shopping-/-Chart-bar#3" stroke="none" stroke-width="1"
                                        ...
                                        <rect id="bound" x="0" y="0" width="24"
                                            height="24"></rect>
                                        <rect id="Rectangle-62-Copy" fill="#335EEA" opacity="0.3" x="7"
                                            y="4" width="3" height="13" rx="1.5"></rect>
                                        <rect id="Rectangle-62-Copy-2" fill="#335EEA" opacity="0.3" x="12"
                                            y="9" width="3" height="8" rx="1.5"></rect>
                                        <path
                                            d="M5,19 L20,19 C20.5522847,19 21,19.4477153 21,20 C21,20.5522847 20.5522847,21 20,21 L4,21 C3.44771525,21 3,20.5522847 3,20 L3,4 C3,3.44771525 3.44771525,3 4,3 C4.55228475,3 5,3.44771525 5,4 L5,19 Z"
                                            id="Path-95" fill="#335EEA"></path>
                                        <rect id="Rectangle-62-Copy-4" fill="#335EEA" opacity="0.3" x="17"
                    ...
                    <div class="mb-5 mb-lg-0" data-aos="fade-up" data-aos-duration="200">
                        <span
                            ...
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                ...
                                <desc>Created with Sketch.</desc>
                                <g id="Stockholm-icons-/-Shopping-/-MC" stroke="none" stroke-width="1"
                                    fill="none" fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24"
                                        height="24"></rect>
                                    <path
